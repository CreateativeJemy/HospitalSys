        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientTypes = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileNumber = table.Column<long>(nullable: false),
                    NameEn = table.Column<string>(nullable: true),
                    NameAr = table.Column<string>(nullable: true),
                    Nationality = table.Column<string>(nullable: true),
                    MFemaleType = table.Column<int>(nullable: false),
                    PatientType = table.Column<int>(nullable: false),
                    Image = table.Column<string>(nullable: true),
                    PatientHistory = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loggers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Inhirtance = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientDesises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientDesises_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientDesises_PatientId",
                table: "PatientDesises",
                column: "PatientId");
        }
